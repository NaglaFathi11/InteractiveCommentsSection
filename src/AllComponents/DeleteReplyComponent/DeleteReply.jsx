        ...
        <div id='deleteReplyBtn'>
           { props.UserName == "juliusomo" ?
              <div id='deleteComment'>
                  ...
                  <button  onClick = {HandleReplyComment}> Delete </button></div>
                  : null }  
                ...
                <div id='confirm-dialog-container'>
                   <div className="confirm-dialog">
                      ...
                      <div id='btns'>
                          ...
                          <button className="confirm-button delete" onClick={HandleConfirmDelete} commentid = {props.commentId}  replyid = {props.replyId} >Yes, Delete</button>
                      </div>
                   </div>
                </div>
        )}
